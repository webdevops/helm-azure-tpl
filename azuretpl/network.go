...
func (e *AzureTemplateExecutor) azureVirtualNetworkAddressPrefixes(resourceID string) []string {
...
func (e *AzureTemplateExecutor) azureVirtualNetworkSubnetAddressPrefixes(resourceID string, subnetName string) []string {
